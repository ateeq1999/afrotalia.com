...
function MnadaPromoPage() {
  return (
    <main className="bg-white font-sans text-[#18181B] antialiased">
      <section className="border-b-2 border-[#18181B] bg-[#09090B] text-white">
        <div className="mx-auto w-full max-w-[1200px] px-5 py-20 sm:px-8 sm:py-28">
          ...
          <p className="mt-6 max-w-[520px] text-[16px] leading-relaxed text-[#8F8F98]">
      ...
      <section className="mx-auto w-full max-w-[1200px] px-5 py-16 sm:px-8 sm:py-20">
        <h2 className="text-[13px] font-bold uppercase tracking-[0.8px] text-[#52525B]">How it works</h2>
        <div className="mt-8 grid grid-cols-1 gap-8 sm:grid-cols-3">
          {FEATURES.map((f) => (
            <div key={f.title} className="border-t-2 border-[#18181B] pt-4">
              <h3 className="text-[16px] font-bold">{f.title}</h3>
              <p className="mt-2 text-[14px] leading-relaxed text-[#52525B]">{f.body}</p>
            </div>
          ))}
        </div>
      </section>
