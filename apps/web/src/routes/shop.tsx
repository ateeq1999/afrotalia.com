...
function ShopPromoPage() {
  return (
    <main className="bg-white font-sans text-[#18181B] antialiased">
      <section className="border-b-2 border-[#18181B]">
        <div className="mx-auto w-full max-w-[1200px] px-5 py-20 sm:px-8 sm:py-28">
          ...
          <p className="mt-6 max-w-[520px] text-[16px] leading-relaxed text-[#52525B]">
      ...
      <section className="mx-auto w-full max-w-[1200px] px-5 py-16 sm:px-8 sm:py-20">
        <h2 className="text-[13px] font-bold uppercase tracking-[0.8px] text-[#52525B]">Why shop here</h2>
